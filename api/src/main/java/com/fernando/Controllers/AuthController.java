...
public class AuthController {
	...
	private boolean checkIfParamsIsNotNull(AccountCredential data) {
		return data == null || data.getUsername() == null || data.getUsername().equals(null) || data.getPassword() == null
				|| data.getPassword().equals(null);
	}
	...
	private boolean checkIfParamsIsNotNull(String userName, String refreshToken) {
		return refreshToken == null || refreshToken.equals(null) || userName == null || userName.equals(null);
	}

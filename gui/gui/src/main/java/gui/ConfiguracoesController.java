...
public class  ConfiguracoesController {
	...
	public void initialize() throws IOException {
		...
		loader.setLocation(getClass().getResource("ConfiguracoesViews/Identificacao.fxml"));
	...
	public void btnLicenca(ActionEvent action) throws IOException {
		limparSelecaoBtns();
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(getClass().getResource("ConfiguracoesViews/Licenca.fxml"));
		getTelaBase().setCenter(loader.load());
	...
	public void btnTabelaIBPT(ActionEvent action) throws IOException {
		limparSelecaoBtns();
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(getClass().getResource("ConfiguracoesViews/TabelaIBPT.fxml"));
		getTelaBase().setCenter(loader.load());
	...
	public void btnCertificado(ActionEvent action) throws IOException {
		limparSelecaoBtns();
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(getClass().getResource("ConfiguracoesViews/Certificado.fxml"));
		getTelaBase().setCenter(loader.load());
